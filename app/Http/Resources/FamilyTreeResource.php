...
class FamilyTreeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'spouse' => $this->nodes['wife'] ?? $this->nodes['husband'] ?? [],
            'sons' => $this->nodes['son'] ?? [],
            ...
            'paternalCousins' => $this->nodes['paternalCousins'] ?? [],
            'maternalCousins' => $this->nodes['maternalCousins'] ?? [],
            'paternalNephewsAndNieces' => $this->nodes['paternalNephewsAndNieces'] ?? [],
            'maternalNephewsAndNieces' => $this->nodes['maternalNephewsAndNieces'] ?? [],
            'nodes' => $this->nodes,
        ];
    }
}
